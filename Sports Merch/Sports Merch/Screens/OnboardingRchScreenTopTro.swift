...
import UIKit
import StoreKit
final class OnboardingRchScreenTopTro: UIViewController {
    init(isView: Bool,
         onboardingModele: OnboardingTopProtocolRchSor) {
        self.isView = isView
    ...
    private let collectionView: UICollectionView = {
        ...
        collView.register(RchsOnboardTroCellRto.self, forCellWithReuseIdentifier: "\(RchsOnboardTroCellRto.self)")
...
extension OnboardingRchScreenTopTro: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "\(RchsOnboardTroCellRto.self)", for: indexPath) as? RchsOnboardTroCellRto else {
