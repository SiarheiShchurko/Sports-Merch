...
final class PushAtrScreenRace: UIViewController {
    ...
    private lazy var continueButton = ClasPrimarySecButtonRace(title: "Enable notifications",
...
private extension PushAtrScreenRace {
    func addTargets() {
